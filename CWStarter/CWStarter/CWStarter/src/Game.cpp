...
Game::~Game()
{
	...
	TexManager::delInstance();
}

void Game::update(float timestep)
{
	//// UPDATE CAMERA AND HUD BASED ON PLAYER POSITION ////
	playerPos = level->getPos();
	view.setCenter(playerPos);
	hud->moveHUD(playerPos);


	//// DICTATES THE WIN/LOSS CONDITIONS AND UPDATES GAME OVER TEXT ////
	...
	//// IF THE GAME HAS NOT BEEN WON/LOST THEN UPDATE THE WORLD ////
	if (!fail && !won)
	{	
		// Update the world
