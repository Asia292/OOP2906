...
{
	if (over)	// Game over bool, will only update player so animation can play
		player->update(timeStep);
	else	// Updates everything if game is not over
	{
